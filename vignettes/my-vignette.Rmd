...
We first illustrate the package use in Shiny. The `startGUI` function launches the UI with a set of initial options.

`startGUI(pd, method = "shiny", value = "pct", gc=TRUE, self= FALSE, memory=TRUE)`
...
`startGUI(pd, method = "gwidgets", value = "pct", gc=TRUE, self= TRUE, memory=TRUE)`
